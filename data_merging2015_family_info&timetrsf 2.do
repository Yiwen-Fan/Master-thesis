...
use "C:\Users\Even\Desktop\修論STATA\data merging 2015\data 2015\Family_Information.dta" 
...
gen livewith=0
foreach i of num 1/14 {
        replace livewith=1 if cb053_`i'_==1 | cb053_`i'_==2 | cb053_`i'_==3
}

foreach i of num 1/14 {
        replace cb053_`i'_=0 if cb053_`i'_==1 | cb053_`i'_==2 | cb053_`i'_==3
}


foreach i of num 1/14 {
        replace cb053_`i'_=1 if cb053_`i'_==4 | cb053_`i'_==5
}

foreach i of num 1/14 {
        replace cb053_`i'_=2 if cb053_`i'_==6
}
...
egen total_contact=rowtotal(cd004_1_ cd004_2_ cd004_3_ cd004_4_ cd004_5_ cd004_6_ cd004_7_ cd004_8_ cd004_9_ cd004_10_ cd004_11_ cd004_12_ cd004_13_ cd004_14_ cd004_15_)
